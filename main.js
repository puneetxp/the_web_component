...
//         div.innerHTML = `
//             <span class="mr-7">${name}
//             </span>
//             <button class="editable-list-remove-item bg-red-100 hover:bg-red-300 h-7 w-7 text-xl icon cursor-pointer rotate-45 rounded-full" style="position: absolute;top: 0;right: 0;margin: 3px;"><span style="margin: auto;width: 100%;display: block;position: absolute;right: -0.2px;top: -0.2px;">&oplus;</span></button>
//         `;
//         return div;
//     }
